...
//                                     }}
//                                     className="w-8 h-8 md:w-15 md:h-15 bg-white rounded-xl out border border-(--main-text-color-light) text-center focus:border-(--main-text-color) text-lg md:text-[22px] font-(--text-font-weight) text-black" />
//                             ))}
//                         </div>
